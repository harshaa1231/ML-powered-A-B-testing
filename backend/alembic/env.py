...
# Built directly rather than via config.set_main_option()/engine_from_config(): configparser
# treats "%" as interpolation syntax, which breaks on a percent-encoded password (e.g. "%40").
